...
public class JsonApiHardwareInformationIntegrationTest {
  ...
  public void getHardwareInformation() throws Exception {
    List<Player> players = Arrays.asList(
      PlayerFactory.createPlayer("Alice", database),
      PlayerFactory.createPlayer("Bob", database),
      PlayerFactory.createPlayer("Charlie", database),
      PlayerFactory.createPlayer("Dave", database),
      PlayerFactory.createPlayer("Elice", database)
    );
