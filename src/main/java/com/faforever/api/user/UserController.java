...
public class UserController {
  ...
  @RequestMapping(path = "/changeLogin", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
  public void changeLogin(@RequestParam("newLogin") String newLogin, Authentication authentication) {
